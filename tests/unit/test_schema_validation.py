...
def test_company_metadata_schema_validation():
    sample_response = {
        # "symbol": "AAPL",
        "price": 178.72,
        "beta": 1.286802,
    ...
    with pytest.raises(ValidationError):
        validate(sample_response, COMPANY_METADATA_RESPONSE_SCHEMA_VALIDATOR)
    ...
    validate(sample_valid_response, COMPANY_METADATA_RESPONSE_SCHEMA_VALIDATOR)
